    ...
    <section className="relative overflow-hidden border-t border-line px-6 py-36 md:px-12 md:py-52">
      ...
      <div className="relative">
        ...
        <a
          ...
          className="mt-12 inline-block border border-accent bg-accent px-8 py-4 font-mono text-sm uppercase tracking-widest text-black transition-colors hover:bg-transparent hover:text-accent focus-visible:bg-transparent focus-visible:text-accent active:translate-y-px"
        >
          {cta.button.label}
        </a>
      </div>
